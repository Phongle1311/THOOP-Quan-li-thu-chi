...
double Family::GetWifeSalary() {
	return wife_salary;
}
double Family::GetHusbandSalary() {
	return husband_salary;
}
double Family::GetOtherIncome() {
	return other_income;
}
double Family::GetBills() {
	return bills;
}
double Family::GetFoodsExpense() {
	return food_expense;
}
double Family::GetOtherExpense() {
